...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>auth</b> with <b>io.github.jan-tennert.supabase:compose-auth</b> coordinates and
         * with version reference <b>composeAuth</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAuth() {
            return create("compose.auth");
        }
    ...
    public static class SupabaseLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public Provider<MinimalExternalModuleDependency> getBom() {
            return create("supabase.bom");
        }

        /**
         * Dependency provider for <b>client</b> with <b>io.github.jan-tennert.supabase:supabase-kt</b> coordinates and
         * with <b>no version specified</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getClient() {
            return create("supabase.client");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidApplication</b> with value <b>8.8.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>composeAuth</b> with value <b>3.1.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getComposeAuth() { return getVersion("composeAuth"); }

        /**
         * Version alias <b>composeBom</b> with value <b>2025.05.01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>composeMaterial3</b> with value <b>1.3.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>composeNavigation</b> with value <b>2.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>hiltAndroidCompiler</b> with value <b>2.56.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>materialIconsExtended</b> with value <b>КОМПОЗЕ_ВЕРСИЯ</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>protoliteWellKnownTypes</b> with value <b>18.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>supabaseKt</b> with value <b>3.1.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>workRuntimeKtx</b> with value <b>2.10.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
